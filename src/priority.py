...
# ЧТО В КОМПОЗИТЕ НА САМОМ ДЕЛЕ.
# Ни taint_share, ни external_share сюда не входят — входит АБСОЛЮТНЫЙ
# external_funding_gap, и это не одно и то же: доля и сумма ведут себя по-разному.
# Фактические корреляции с итоговым приоритетом: taint_share +0.31,
# external_share -0.31. То есть приоритет выше у узлов с деньгами фигурантов,
# а не у разбавленных внешними. Ниже объяснено, почему taint не берём напрямую,
# но не следует читать это как «external_share учтён косвенно» — он не учтён.
#
